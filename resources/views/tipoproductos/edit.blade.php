    ...
    <div class="py-6">        
        ...
        <div class="bg-blue-200 py-32 px-10 min-h-screen ">
            ...
            <div class="bg-white p-10 md:w-3/4 lg:w-1/2 mx-auto">
              ...
              <form action="{{route('tipoproductos.update', $tipoproducto)}}" method="POST">
                @csrf @method('put')
                ...
                <div class="flex items-center mb-5">
                  ...
                  <input value="{{old('nombre', $tipoproducto->nombre)}}" type="text" name="nombre" 
