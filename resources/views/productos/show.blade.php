                ...
                <div class="h-screen">
                    ...
                    <div class="bg-white shadow-2xl rounded-b-3xl">
                        ...
                        <div class="col-span-2 pt-1">
                            <p class="text-gray-800 font-bold lg:text-sm">Precio:</p><p class="text-gray-800 font-regular lg:text-sm">{{$producto->precio}}</p>
                            ...
                            <p class="text-gray-800 font-bold lg:text-sm">Ingredientes:</p><p class="text-gray-800 font-regular lg:text-sm">
                                @foreach ($ingredientes as $ingrediente)
                                    @if ($ingrediente->id == $producto->ingrediente_id)
                                        {{$ingrediente->detalle}}
                                    @endif
                                @endforeach
                            </p>
